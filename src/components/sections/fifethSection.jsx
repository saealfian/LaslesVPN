    ...
    return (
        ...
        <div className="fifthSectionLeft">
            ...
            <div className="fifthSectionLeftMore">
                <img src="/src/assets/backWhite.png" alt="" srcset="" className="fifthSectionLeftBack"/>
                <p className="fifthSectionLeftMeet">Meet Tohbad</p>
            </div>
        </div>
        <div className="fifthSectionRight">
            <img src="/src/assets/computer.png" alt="" srcset="" className="fifthSectionRightImage"/>
        </div>
    </div>
    )
}

export default FifethSection